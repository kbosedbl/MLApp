...
public class BarCode extends AppCompatActivity {
    ...
    private void rundetector(Bitmap bitmap) {
        ...
        FirebaseVisionBarcodeDetectorOptions options=new FirebaseVisionBarcodeDetectorOptions.Builder().setBarcodeFormats(FirebaseVisionBarcode.FORMAT_QR_CODE, FirebaseVisionBarcode.FORMAT_PDF417).build();
        ...
        detector.detectInImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionBarcode>>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(BarCode.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
